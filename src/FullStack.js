...
Full Stack Training</h1>
        <p className="text-gray-700 text-lg leading-relaxed mb-6">
        If you're interested in pursuing a career as a full stack developer, we offer a comprehensive training program that covers both front-end and back-end development. Our includes a range of topics, from HTML and CSS to JavaScript and Node.js, ensuring that you have the skills and knowledge you need to succeed in this field. Enroll in our program today and take the first step towards achieving your career goals.
        </p>
